        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-header">
                    <div class="page-number">
                        <nav aria-label="Page navigation">
                          <ul class="pagination">
                            <li class="page-item">{{$inboxData->links()}}</a></li>
                          </ul>
                        </nav>
                      </div>
                </div>
                <div class="card-body">
                    ...
                    @endif
                    @if (session('user-not-exists-error'))
                        <div class="alert alert-success" role="alert">
                            {{ session('user-not-exists-error') }}
                        </div>
                    @endif
                    @if (session('save-draft-success'))
                        <div class="alert alert-success" role="alert">
                            {{ session('save-draft-success') }}
                        </div>
                    @endif
                        ...
                        <tbody>
                            ...
                            <td>
                                <div class="justify-content-center">
                                    ...
                                    <a href="{{route('viewEmail',$item->id)}}" class="btn btn-success text-white font-weight-bold">View</a>
